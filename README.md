...
An Inventory System using CodeIgniter, MySQL &amp; PHP
...
1. Download files. Add them to your Root folder if you are using XAMMP the location is "C:\xampp\htdocs\inv\".
...
Licensed under WapSecure Incoepration incase you want to use it for production purposes.
